...
const questions = [
  ...
  What is the least costly route for the royal messenger to reach Emerald Harbor (F) from the Golden Palace (A)?`,
    questionImage: "Client/src/assets/images/q1.jpeg",
    options: [
  ...
  After completing this single royal sweep, what is the new arrangement of the treasure chests?`,
    questionImage: "Client/src/assets/images/q2.jpeg",
    options: [
...
What is the output of the above code?`,
    questionImage: "Client/src/assets/images/q3.jpeg",
    options: [
...
including small, medium, and large ones.`,
    questionImage: "Client/src/assets/images/q4.webp",
    options: [
      { text: "12", image: null },
      { text: "13", image: null },
      { text: "14", image: null },
...
Find the correct figure from the given options that perfectly replaces the missing part (?) in the problem figure and restores the royal pattern.`,
    ...
    options: [
      { text: null, image: "Client/src/assets/images/q5-1.png" },
      { text: null, image: "Client/src/assets/images/q5-2.png" },
      { text: null, image: "Client/src/assets/images/q5-3.png" },
      { text: null, image: "Client/src/assets/images/q5-4.png" }
    ],
    correct: 0
  }
]
