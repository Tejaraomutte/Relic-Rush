...
import RoundHeader from '../src/components/RoundHeader'
import QuestionCard from '../src/components/QuestionCard'
import ActionButtons from '../src/components/ActionButtons'
import ResultMessage from '../src/components/ResultMessage'
import ScoreDisplay from '../src/components/ScoreDisplay'
import LampDisplay from '../src/components/LampDisplay'
import { submitRoundScore } from '../src/utils/api'
import { startTimer, autoSubmitRound, showResults } from '../src/utils/roundFlow'
import { saveRoundState, loadRoundState, markRoundCompleted, isRoundCompleted } from '../src/utils/sessionManager'
...
Find the correct figure from the given options that perfectly replaces the missing part (?) in the problem figure and restores the royal pattern.`,
    ...
    options: [
      { text: null, image: "/q5-1.png" },
      { text: null, image: "/q5-2.png" },
      { text: null, image: "/q5-3.png" },
      { text: null, image: "/q5-4.png" }
    ],
    correct: 0
  }
]
